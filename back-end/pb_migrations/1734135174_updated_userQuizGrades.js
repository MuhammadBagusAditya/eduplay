...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("kvejdduf")

  // remove
  collection.schema.removeField("xcdqgm45")

  // remove
  collection.schema.removeField("vql6ukkh")

  // remove
  collection.schema.removeField("pqdsebhc")
