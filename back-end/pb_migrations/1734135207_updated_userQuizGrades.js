...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("3ksm5maf")

  // remove
  collection.schema.removeField("2hqqbkcu")

  // remove
  collection.schema.removeField("cy8wzhm6")

  // remove
  collection.schema.removeField("mu73gq30")
