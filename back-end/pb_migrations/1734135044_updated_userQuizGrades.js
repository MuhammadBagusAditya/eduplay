...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("pqqx06wc")

  // remove
  collection.schema.removeField("eho3j33f")

  // remove
  collection.schema.removeField("jsewqcow")

  // remove
  collection.schema.removeField("aadv3nrq")
