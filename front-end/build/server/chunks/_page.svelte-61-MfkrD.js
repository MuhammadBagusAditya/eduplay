            ...
            children: ($$payload3) => {
              if (classroom.expand?.quizzes_via_classroom.length > 0) {
                ...
                for (let $$index = 0, $$length2 = each_array_1.length; $$index < $$length2; $$index++) {
                  ...
                  $$payload3.out += `<div class="flex w-full items-center justify-between gap-3"><a class="flex-1 overflow-hidden text-ellipsis whitespace-nowrap capitalize"${attr("href", "/dashboard/quizzes/" + quiz.id)}>${escape_html(quiz.name)}</a> `;
                  if (quiz.status === "open") {
                    $$payload3.out += "<!--[-->";
                    Badge($$payload3, {
                      children: ($$payload4) => {
...
//# sourceMappingURL=_page.svelte-61-MfkrD.js.map
