...
const load = async ({ locals }) => {
  const classes = await pb.collection("classes").getFullList({
    ...
    expand: "assignments_via_classroom",
    sort: "name"
  });
