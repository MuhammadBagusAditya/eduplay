...
function _page($$payload, $$props) {
  ...
  const form = superForm(data.form, {
    validators: zodClient(editAssignmentSchema),
    resetForm: false
  });
  ...
  function $$render_inner($$payload2) {
    head($$payload2, ($$payload3) => {
      $$payload3.title = `<title>Eduplay - Ubah ${escape_html(data.assignment.name)}</title>`;
    });
    $$payload2.out += `<main class="grid grid-cols-1 gap-6"><h1 class="text-3xl font-bold text-slate-800">${escape_html(data.assignment.name)}</h1> <!---->`;
    Breadcrumb($$payload2, {
      children: ($$payload3) => {
        $$payload3.out += `<!---->`;
          ...
          children: ($$payload4) => {
            ...
            Breadcrumb_item($$payload4, {
              children: ($$payload5) => {
                $$payload5.out += `<!---->`;
                Breadcrumb_link($$payload5, {
                  href: "/dashboard/teachers/assignments/" + data.assignment.id,
                  class: "capitalize",
                  children: ($$payload6) => {
    ...
    $$payload2.out += `<!----> <div class="flex flex-col gap-6"><div class="flex flex-col gap-4 rounded-lg bg-slate-100 px-6 py-4 shadow shadow-slate-900/20"><h3 class="text-xl font-bold text-primary">Data tugas</h3> <form method="POST" class="flex flex-col gap-3"><!---->`;
    Form_field($$payload2, {
      form,
      name: "name",
      children: ($$payload3) => {
...
//# sourceMappingURL=_page.svelte-CB8nyYET.js.map
