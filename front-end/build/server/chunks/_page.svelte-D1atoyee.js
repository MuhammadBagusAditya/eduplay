...
function _page($$payload, $$props) {
  ...
  function $$render_inner($$payload2) {
    head($$payload2, ($$payload3) => {
      $$payload3.title = `<title>Eduplay - Ubah ${escape_html(data.material.name)}</title>`;
    });
    $$payload2.out += `<main class="grid grid-cols-1 gap-6"><h1 class="text-3xl font-bold capitalize text-slate-800">${escape_html(data.material.name)}</h1> <!---->`;
    Breadcrumb($$payload2, {
      children: ($$payload3) => {
        $$payload3.out += `<!---->`;
            ...
            Breadcrumb_item($$payload4, {
              children: ($$payload5) => {
                ...
                Breadcrumb_link($$payload5, {
                  ...
                  class: "capitalize",
                  children: ($$payload6) => {
                    $$payload6.out += `<!---->${escape_html(data.material.expand?.classroom.name)}`;
                  },
                  $$slots: { default: true }
                });
                $$payload5.out += `<!---->`;
            ...
            Breadcrumb_item($$payload4, {
              children: ($$payload5) => {
                ...
                Breadcrumb_link($$payload5, {
                  ...
                  class: "capitalize",
                  children: ($$payload6) => {
                    $$payload6.out += `<!---->${escape_html(data.material.name)}`;
                  },
                  $$slots: { default: true }
                });
                $$payload5.out += `<!---->`;
    ...
    $$payload2.out += `<!----> <div class="flex flex-col gap-6"><div class="flex flex-col gap-4 rounded-lg bg-slate-100 px-6 py-4 shadow shadow-slate-900/20"><h3 class="text-xl font-bold text-primary">Data materi</h3> <form method="POST" class="flex flex-col gap-3"><!---->`;
    Form_field($$payload2, {
      form,
      name: "name",
      children: ($$payload3) => {
    ...
    $$payload2.out += `<!----> <div class="flex justify-end gap-3">`;
    Button($$payload2, {
      type: "submit",
      children: ($$payload3) => {
        $$payload3.out += `<!---->Submit`;
...
//# sourceMappingURL=_page.svelte-D1atoyee.js.map
