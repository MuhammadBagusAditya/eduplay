            ...
            children: ($$payload3) => {
              if (classroom.expand?.assignments_via_classroom.length > 0) {
                ...
                for (let $$index = 0, $$length2 = each_array_1.length; $$index < $$length2; $$index++) {
                  ...
                  $$payload3.out += `<div class="flex w-full items-center justify-between gap-3"><a class="flex-1 overflow-hidden text-ellipsis whitespace-nowrap capitalize"${attr("href", "/dashboard/teachers/assignments/" + assignment.id)}>${escape_html(assignment.name)}</a> `;
...
//# sourceMappingURL=_page.svelte-DfxQslw4.js.map
