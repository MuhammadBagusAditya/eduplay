import { q as copy_payload, t as assign_payload, p as pop, o as head, l as escape_html, a as store_get, d as attr, u as unsubscribe_stores, b as push, s as spread_props, A as store_mutate, h as spread_attributes, e as ensure_array_like } from './index2-JzpfwCt6.js';
...
function _page($$payload, $$props) {
  ...
  function $$render_inner($$payload2) {
    head($$payload2, ($$payload3) => {
      $$payload3.title = `<title>Eduplay - Edit kelas ${escape_html(data.classroom.name)}</title>`;
    });
    $$payload2.out += `<main class="grid grid-cols-1 gap-6"><h1 class="text-3xl font-bold capitalize text-slate-800">Edit Kelas ${escape_html(data.classroom.name)}</h1> <!---->`;
    Breadcrumb($$payload2, {
      children: ($$payload3) => {
        $$payload3.out += `<!---->`;
    ...
    $$payload2.out += `<!----> <div class="flex flex-col gap-6"><div class="flex flex-col gap-4 rounded-lg bg-slate-100 px-6 py-4 shadow shadow-slate-900/20"><h3 class="text-xl font-bold text-primary">Data kelas</h3> <form method="POST" class="flex flex-col gap-3" enctype="multipart/form-data"><!---->`;
    Form_field($$payload2, {
      form,
      name: "name",
      children: ($$payload3) => {
...
//# sourceMappingURL=_page.svelte-DGyHB3M1.js.map
