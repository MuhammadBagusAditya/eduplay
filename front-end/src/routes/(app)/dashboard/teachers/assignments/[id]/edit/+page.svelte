...
<svelte:head>
	<title>Eduplay - Ubah {data.assignment.name}</title>
</svelte:head>

<main class="grid grid-cols-1 gap-6">
	<h1 class="text-3xl font-bold text-slate-800">{data.assignment.name}</h1>
		...
		<Breadcrumb.List>
			...
			<Breadcrumb.Item>
				<Breadcrumb.Link
					...
					class="capitalize">{data.assignment.name}</Breadcrumb.Link
				>
			</Breadcrumb.Item>
	...
	<div class="flex flex-col gap-6">
		<div class="flex flex-col gap-4 rounded-lg bg-slate-100 px-6 py-4 shadow shadow-slate-900/20">
			<h3 class="text-xl font-bold text-primary">Data tugas</h3>
